...
if ($id > 0) {
    ...
    $stmt->execute([$id]);
    $movie = $stmt->fetch();
    if (!$movie) { setFlash('error', 'Film not found.'); redirect('/panel/movies.php'); }
    $isEdit = true;
    // Load current genres
    ...
    <div class="admin-content">
      <div class="admin-top">
        ...
        <div style="display:flex;gap:var(--s-3);">
          ...
          <?php endif; ?>
          <a href="<?= BASE_URL ?>/panel/movies.php" class="btn btn-ghost">← Back to Films</a>
        </div>
      </div>
      ...
      <div class="admin-form-layout">
        ...
        <form method="POST" class="admin-form">
          ...
          <div class="form-actions">
            ...
            <a href="<?= BASE_URL ?>/panel/movies.php" class="btn btn-ghost">Cancel</a>
          </div>
        </form>
