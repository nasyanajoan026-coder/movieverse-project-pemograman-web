    ...
    <div class="admin-content">
      ...
      <div class="admin-stats-grid">
        <div class="admin-stat-card">
          ...
          <a href="<?= BASE_URL ?>/panel/movies.php" class="asc-link">Manage →</a>
        </div>
        <div class="admin-stat-card">
          <span class="asc-icon">🏷</span>
          <div class="asc-body">
          ...
          <a href="<?= BASE_URL ?>/panel/genres.php" class="asc-link">Manage →</a>
        </div>
        <div class="admin-stat-card">
          <span class="asc-icon">📝</span>
          <div class="asc-body">
          ...
          <a href="<?= BASE_URL ?>/panel/reviews.php" class="asc-link">Moderate →</a>
        </div>
        <div class="admin-stat-card">
          <span class="asc-icon">👤</span>
          <div class="asc-body">
      ...
      <div class="admin-quick-actions">
        <a href="<?= BASE_URL ?>/panel/movie-form.php" class="btn btn-primary">+ Add New Film</a>
        <a href="<?= BASE_URL ?>/panel/genres.php?action=add" class="btn btn-outline-gold">+ Add Genre</a>
      ...
      <section class="admin-section">
        <div class="admin-section-header">
          ...
          <a href="<?= BASE_URL ?>/panel/reviews.php" class="view-all-link">View all →</a>
        </div>
            ...
            <tbody>
              ...
              <?php else: ?>
                ...
                <tr>
                  ...
                  <td>
                    <form method="POST" action="<?= BASE_URL ?>/panel/reviews.php" class="inline-form">
