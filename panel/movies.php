  ...
  <div class="admin-layout">
    ...
    <div class="admin-content">
      <div class="admin-top">
        ...
        <a href="<?= BASE_URL ?>/panel/movie-form.php" class="btn btn-primary">+ Add Film</a>
      </div>
      ...
      <form method="GET" class="admin-search-form">
        ...
        <?php if ($q): ?><a href="<?= BASE_URL ?>/panel/movies.php" class="btn btn-ghost">Clear</a><?php endif; ?>
      </form>
            ...
            <?php else: ?>
              ...
              <tr>
                ...
                <td class="action-cell">
                   <a href="<?= BASE_URL ?>/panel/movie-form.php?id=<?= $m['id'] ?>" class="btn btn-ghost btn-sm">Edit</a>
