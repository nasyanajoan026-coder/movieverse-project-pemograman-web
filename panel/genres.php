                ...
                <?php else: ?>
                  ...
                  <tr class="<?= $editGenre && $editGenre['id'] === $g['id'] ? 'row-editing' : '' ?>">
                    ...
                    <td class="action-cell">
                      <a href="<?= BASE_URL ?>/panel/genres.php?edit=<?= $g['id'] ?>" class="btn btn-ghost btn-sm">Edit</a>
            ...
            <form method="POST" class="admin-form compact">
              ...
              <div class="form-actions">
                <button type="submit" class="btn btn-primary">Save</button>
                 <a href="<?= BASE_URL ?>/panel/genres.php" class="btn btn-ghost">Cancel</a>
              </div>
            </form>
          </section>
          <?php endif; ?>
